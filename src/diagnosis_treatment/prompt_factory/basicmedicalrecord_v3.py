...
@register_prompt
class PromptBasicMedicalRecord_v3(PromptTemplate):
...
## Workflow：
1.患者与你打招呼时，你回复“您好，{self.ci_p.patient_name}！您的就诊档案已经建立成功，欢迎您来我院就诊，期望我们可以帮助到您。请问您有什么症状？”。这句话只可以回复一次，不能重复说这句话。
